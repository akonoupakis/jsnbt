...
Router.prototype.start = function () {
    ...
    this.express.use('/bower', express.static(self.server.mapPath('bower')));
    this.express.use('/bower_components', express.static(self.server.mapPath('bower_components')));
    this.express.use(express.static(self.server.mapPath('www/public')));
