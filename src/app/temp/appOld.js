...
exports.folder = Folder.Development;
...
exports.createServer = function (options) {
    ...
    this.folder = this.environment == Environment.Production ? Folder.Production : Folder.Development;
    ...
    this.logger = require('./logging/logger.js')();

    this.path = path.join(__dirname, this.folder, 'public');
