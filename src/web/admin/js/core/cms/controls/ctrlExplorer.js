...
(function () {
    ...
    angular.module('jsnbt')
        .directive('ctrlExplorer', ['$rootScope', 'FileService', 'ModalService', 'CONTROL_EVENTS', function ($rootScope, FileService, ModalService, CONTROL_EVENTS) {

            var ExplorerControl = function (scope, element, attrs) {
            ...
            ExplorerControl.prototype = Object.create(jsnbt.controls.ControlBase.prototype);
