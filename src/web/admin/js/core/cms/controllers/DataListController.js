...
(function () {
    ...
    var DataListController = function ($scope, $rootScope, $logger, $q, $data, $jsnbt, ModalService, LocationService) {
    ...
    angular.module("jsnbt")
        .controller('DataListController', ['$scope', '$rootScope', '$logger', '$q', '$data', '$jsnbt', 'ModalService', 'LocationService', DataListController]);
})();