...
(function () {
    ...
    angular.module("jsnbt")
        .controller('NodeFormControllerBase', ['$scope', '$controller', '$route', '$rootScope', '$routeParams', '$location', '$data', '$q', '$timeout', '$jsnbt', '$fn', 'AuthService', 'TreeNodeService', 'LocationService', 'ScrollSpyService', 'ModalService', 'DATA_EVENTS', 'CONTROL_EVENTS',
            ...
            $controller('FormControllerBase', $scope.base);
            ...
            $scope.init = function () {
                ...
                $timeout(function () {
                    $q.all(fn.setLayouts(), fn.setRoles(), fn.setRobots(), fn.setModules(), fn.setLanguages(), fn.setLanguage(), fn.setEntities(), fn.setRoutes(), fn.setViews()).then(function () {
