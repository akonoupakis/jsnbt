    ...
    (function (jsnbt) {
        ...
        jsnbt.controllers = (function (controllers) {
            ...
            controllers.NodeFormControllerBase = (function (NodeFormControllerBase) {
                ...
                NodeFormControllerBase = function ($scope, $rootScope, $route, $routeParams, $location, $logger, $q, $timeout, $data, $jsnbt, LocationService, ScrollSpyService, AuthService, TreeNodeService, PagedDataService, ModalService, CONTROL_EVENTS, AUTH_EVENTS, DATA_EVENTS, ROUTE_EVENTS) {
