    ...
    (function (jsnbt) {
        ...
        jsnbt.controllers = (function (controllers) {
            ...
            controllers.SettingsControllerBase = (function (SettingsControllerBase) {
                ...
                SettingsControllerBase = function ($scope, $rootScope, $router, $location, $logger, $q, $timeout, $data, $jsnbt, LocationService, ScrollSpyService, AuthService, FileService,NodeService, ModalService, CONTROL_EVENTS, AUTH_EVENTS, DATA_EVENTS, ROUTE_EVENTS, MODAL_EVENTS) {
