    ...
    (function (jsnbt) {
        ...
        jsnbt.controls = (function (controls) {
            ...
            controls.FormControlBase = (function (FormControlBase) {
                ...
                FormControlBase = function (scope, element, attrs, $rootScope, $router, $logger, $q, $timeout, $data, $jsnbt, RouteService, LocationService, ScrollSpyService, AuthService, TreeNodeService, PagedDataService, ModalService, CONTROL_EVENTS, AUTH_EVENTS, DATA_EVENTS, ROUTE_EVENTS) {
